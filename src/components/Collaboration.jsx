    ...
    <Section crosses>
        <div className="container lg:flex">
            ...
            <div className='lg:ml-auto xl:w-[38rem]'>
                <p className='body-2 mb-8 text-n-4 md:mb-16 lg:mb-32 lg:2-[22rem] lg:mx-auto'>{collabText}</p>
                ...
                -translate-x-1/2 scale:75 md:scale-100'>
                    <div className='flex w-60 aspect-square m-auto border border-n-6 rounded-full'>
                        <div className='flex w-[6rem] m-auto p-[0.2rem] aspect-square bg-conic-gradient border border-n-6 rounded-full'>
